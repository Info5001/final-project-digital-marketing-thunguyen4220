...
public class Order {
    ...
    public OrderItem newOrderItem(SolutionOffer solutionOffer, int actualPrice, int quantity) {
        OrderItem oi = new OrderItem(solutionOffer, actualPrice, quantity, this);
        orderItems.add(oi);
        return oi;
    }
